...
class Trainer:
    def __init__(self,load_path=None):
        ...
        test_data_path="data/4sin_split/test.csv"

        # total_data_path="data/data_train.json"
        self.batch_size=128
        self.seq_len=512
        self.epochs=100
        self.model_name="LSTM_attn_4sin"
    ...
    def evaluate(self,save_path):
        ...
        for data in tqdm(self.test_iter):
            ...
            #         sp_cnt+=1
            #         print((self.idx2charge[label_lst[i]],self.idx2charge[out_lst[i]]))
            # print(sp_cnt)
            # createHTML(sp_sents,sp_attention,"logs/LSTM_attn_4sin/抢夺attention{}.html".format(bat_cnt))
...
if __name__=="__main__":
    trainer= Trainer()
    # trainer.train()
    trainer.evaluate("logs/LSTM_attn_4sin/model_47")
